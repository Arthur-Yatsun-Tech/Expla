...
from layouts.layouts_handlers.main_window.elements.buttons import planning_table, set_buttons_disabled
from layouts.layouts_handlers.main_window.elements.qlines import set_factors, set_experiments
from layouts.layouts_handlers.main_window.elements import set_level
